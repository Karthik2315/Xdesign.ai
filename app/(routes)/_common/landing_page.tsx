      ...
      <div className='flex flex-col'>
        ...
        <div className='relative overflow-hidden pt-28'>
          <div className='max-w-6xl mx-auto flex flex-col items-center justify-center'>
            <div className='space-y-3'>
              <h1 className='text-center font-semibold text-4xl sm:text-5xl'>Design mobile apps <span className='text-primary'>in minutes</span></h1>
            ...
            <div className='flex w-full max-w-3xl flex-col items-center gap-8 relative z-50'>
              ...
              <div className='flex flex-wrap justify-center gap-2 px-5'>
                <Suggestions>
                  {suggestions.map((s)=>(
                    <Suggestion key={s.label} suggestion={s.value} className='text-xs h-7 px-2.5 pt-1' onClick={()=>handleSuggestionClick(s.value)}>
                      {s.icon}
                      <span>{s.label}</span>
                    </Suggestion>
                  ))}
        ...
        <div className='w-full py-10'>
          <div className='mx-auto max-w-3xl'>
            <div>
              <h1 className='font-medium text-xl'>Recent Projects</h1>
            </div>
          </div>
        </div>
      </div>
